 ...
 */
public class TinTucDaoTaoFragment extends Fragment {
    private static String TAG = TinTucDaoTaoFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tintucdaotaofragment, container, false);
...
//kiem tra xem co du lieu hay khong
        if(mRssItemHelper.getRssItemCount() ==0 && mNetworkUtils.isConnectingToInternet()) {
            getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    readXML.execute("http://daotao.ued.vn/feed/");
        ...
        {
            mListRssItemAdapter = new ListRssItemAdapter(getActivity(),mRssItemHelper.getAllItemsRssDaoTao(),onItemClickCallback );
        ...
        mArrayList= mRssItemHelper.getAllItemsRssDaoTao();
        return view;
    }
    public class ReadXmlPullParse extends AsyncTask<String, Integer, List<RssItem>> {
        ...
        public void onPostExecute(List<RssItem> rssItems) {
            ...
            for (int i=0 ; i<rssItems.size() ; i++){
                mRssItemHelper.addNewItemRssDaoTao(rssItems.get(i));
            }
            Log.d(TAG, mRssItemHelper.getAllItemsRssDaoTao()+"");
            mListRssItemAdapter = new ListRssItemAdapter(getActivity(),mRssItemHelper.getAllItemsRssDaoTao(), onItemClickCallback);
            mListRssItemAdapter.notifyDataSetChanged();
            mRecyclerView.setAdapter(mListRssItemAdapter);
        }
