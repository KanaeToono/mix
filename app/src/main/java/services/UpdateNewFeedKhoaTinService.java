 ...
 */
public class UpdateNewFeedKhoaTinService extends Service{
private static String TAG = UpdateNewFeedKhoaTinService.class.getSimpleName();
    ...
    protected void onPostExecute(List<RssItem> rssItems) {
        super.onPostExecute(rssItems);
            for (int i = 0; i < rssItems.size(); i++) {
                Log.d(TAG, mRssItemDatabase.getRssItemLastPubDateKhoaTin() + "");
